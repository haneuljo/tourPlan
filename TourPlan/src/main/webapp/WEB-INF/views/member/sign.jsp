        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" action="<%=cp%>/memberSign" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="name" placeholder="Enter password">
            </div>
            
              <button type="submit" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> sign</button>
          </form>
        </div>
